...
export default async function BlogPostPage(props: { 
  ...
  // Solo hacemos el llamado estándar, Prisma ya trae todos los campos del Post (incluyendo autor)
  ...
  // Obtenemos la bio en el idioma correcto
      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        ...
        {post.authorName && (
          <div className="flex items-center gap-4 mb-8 p-4 bg-gray-800/50 rounded-lg border border-gray-700/50">
            {/* Foto del autor o inicial si no hay foto */}
            {post.authorImage ? (
              <Image 
            ...
            <div className="flex flex-col">
               ...
               {/* Si el post incluye una biografía, la mostramos debajo del nombre */}
               {authorBio && (
