    ...
    <div className="min-h-screen bg-[#111111] text-gray-200 font-sans pb-20">
      ...
      <div className="bg-[#1a1a1a] border-b border-gray-800 pt-10 pb-6 px-4 sm:px-6 lg:px-8 sticky top-0 z-10 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <Link href="/admin" className="text-[#f8ed1a] text-sm font-bold hover:underline mb-2 inline-block">
              &larr; Back to Dashboard
            </Link>
            <h1 className="text-3xl font-black text-white uppercase tracking-tight">
              {isLease ? 'Lease Agreement Details' : 'Contract Details'}
            </h1>
            <p className="text-gray-400 text-sm mt-1">Agreement ID: <span className="font-mono text-gray-500">{agreement.id}</span></p>
          </div>
          <div>
              ...
              <tbody className="divide-y divide-gray-800 bg-[#1a1a1a]">
                {payments.length === 0 ? (
                  ...
                  payments.map((payment: any) => {
                    ...
                    // Solo sumamos el Service Fee fijo si es una compra (!isLease)
