...
// --- AHORA RECIBE SELLERS COMO PROP ---
export default function NewPropertyForm({ sellers = [] }: { sellers?: SellerProfileOption[] }) {
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-gray-700">
                    <div>
                        ...
                        <input type="text" name="focusKeywordEn" placeholder="Focus Keyword" className="mt-2 block w-full rounded bg-gray-900 border-0 text-white ring-1 ring-gray-700 sm:text-sm" />
                    </div>
                    <div>
                        ...
                        <input type="text" name="focusKeywordEs" placeholder="Focus Keyword" className="mt-2 block w-full rounded bg-gray-900 border-0 text-white ring-1 ring-gray-700 sm:text-sm" />
                    </div>
                </div>
            </div>
          </AccordionSection>
...
{/* --- AGENT PORTAL / REP DASHBOARD --- */}
          <AccordionSection title="Agent Portal Details" icon="💼">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
              ...
              {/* Emoji & Condition */}
              <div>
                <label htmlFor="emoji" className="block text-sm font-medium leading-6 text-white">Emoji Identificador</label>
                <div className="mt-2">
